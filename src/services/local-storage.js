...
class LocalStorageService {
  constructor() {
    ...
    this._apiToken =
      'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI0ZWJkMTAxYTg5N2YwMjZiODYzYjA5OWU2NWRkNDBhYSIsInN1YiI6IjY0ZTA5ZTM4YTNiNWU2MDFkNjNhNzg3OCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.MYI-y3ovfrHVd0jW6YIdwBgJhfmWdttD7uXVNKzqQa';
    this.addTokenToLocalStorage();
    this.addKeyToLocalStorage();
    this.movieApi = new MovieApiService();

    this.getSessionIdToStorage = async () => {
      try {
